...
import net.devstudy.jse.lection06_gomoku.impl_my.DefaultComputerTurn;
import net.devstudy.jse.lection06_gomoku.impl_my.DefaultGameTable;
import net.devstudy.jse.lection06_gomoku.impl_my.DefaultHumanTurn;
import net.devstudy.jse.lection06_gomoku.impl_my.DefaultWinnerChecker;
import net.devstudy.jse.lection06_gomoku.impl_my.RandomComputerTurn;

public class GUIGomoku extends JFrame {

	private static final Logger LOGGER = LoggerFactory.getLogger(GUIGomoku.class);

	private static final long serialVersionUID = 3064773187230502709L;
	...
	public GUIGomoku() throws HeadlessException {
		...
		//computerTurn = new RandomComputerTurn();
