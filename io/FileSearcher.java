...
public class FileSearcher {
	...
	public static void main(String[] args) throws IOException {
		FileSearcher fileSearcher = new FileSearcher(Paths.get("d:/workspace/jse/bin/net/devstudy/jse."), "*$*.*");
		//FileSearcher fileSearcher = new FileSearcher(Paths.get("d:/workspace/jse/bin/net/devstudy/jse."), "*$*.cl*ss");
		//????.java 
		//FileSearcher fileSearcher = new FileSearcher(Paths.get("d:/workspace/jse/src/net/devstudy/jse."), "????.java");
		//FileSearcher fileSearcher = new FileSearcher(Paths.get("d:/workspace/jse/bin/net/devstudy/jse."), "LabelFrame.class");
